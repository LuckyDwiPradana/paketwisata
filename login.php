            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0" >
                        ...
                        <div class="row" >
                            <div class="col-lg-6 d-lg-block bg-primary shadow-lg p-5 text-center" style="background-image: url('assets/img/adatkebo.jpg');">
                                <!-- <img src="assets/img/kebo-bg.jpeg" alt="logo" width="200">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="proses_login.php" method="POST">
                                        ...
                                        <hr>
                                    <div class="text-center">
                                        <a class="small">Travel. Banyuwangi | 2023 - <?=date('Y')?></a>
                                    </div>
                                </div>
                            </div>
                        </div>
